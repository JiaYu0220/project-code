import{c as ce,i as k,h as le,a as g,u as N}from"./main-64c8deac.js";import{h as ne}from"./startCourse-2b1863b9.js";import{s as oe,a as ie,b as _}from"./swal-5831e0de.js";let B=document.querySelector("#js-filter-bar"),U=document.querySelector("#js-sticky-mt");const W=document.querySelector(".navbar");window.addEventListener("scroll",()=>{let e;window.innerWidth<375?e=120:window.innerWidth<768?e=300:e=418,window.scrollY<e?(B.style.boxShadow="",U.style.marginTop="",W.style.display="block"):(B.style.boxShadow="0 10px 6px -6px rgba(0, 0, 0, 0.15)",U.style.marginTop="78px",W.style.display="none")});window.addEventListener("resize",function(){(window.innerWidth||document.documentElement.clientWidth)<1200&&document.getElementById("collapseFilter").classList.add("show")});const Y=document.querySelectorAll(".js-selectedFiltersNum");let u=0;const F=document.querySelectorAll('input[name="filterStar"]'),f=document.querySelector("input[name='minPrice']"),p=document.querySelector("input[name='maxPrice']");let de=document.querySelector("#accordionFilter");const Z=document.querySelectorAll(".js-category"),ue=document.querySelector(".js-delFilterBtn");function j(){s.page=1,P(),i(s),Q(),je(s)}function fe(){s.page=1,P(),i(s),Q()}F.forEach(e=>{e.addEventListener("change",a=>{pe(a.target.id)})});function pe(e){s.rate_gte={allStar:0,filterStar5:5,filterStar4:4,filterStar3:3,filterStar2:2,filterStar1:1}[e],fe()}f.addEventListener("change",G);p.addEventListener("change",G);function G(){const e=parseInt(this.value.trim());let a,t;this===f?(a=M,t=s.price_gte):this===p&&(a=D,t=s.price_lte),isNaN(e)?(this===f?s.price_gte=a:this===p&&(s.price_lte=a),j()):e!==t&&(this===f?s.price_gte=e:this===p&&(s.price_lte=e),j())}const J=sessionStorage.getItem("cateItemName");J&&document.addEventListener("DOMContentLoaded",me);function me(){const e=document.querySelector(`#${J}`);e.checked=!0,K(e),sessionStorage.removeItem("cateItemName")}de.addEventListener("change",e=>K(e.target));function K(e){if(e.classList.contains("js-selectAll")){const a=e.checked,t=document.querySelectorAll(`input[id^="${e.name}"]:not([id="${e.name}"])`);t.length&&t.forEach(c=>{c.checked=a})}else if(e.type="checkbox"){const a=e.closest(".accordion-item").querySelector(".js-selectAll"),t=e.closest(".accordion-body").querySelectorAll(".js-category");be(a,t)}ge(),j()}function ge(){s.filters="";let e="",a="";Z.forEach(t=>{t.checked&&(t.value==="入門"||t.value==="進階"?(a=`&level_like=${t.value}`,s.filters+=a):(he(t.value)?(e=`&categories_like=\\b${t.value}\\b`,t.value==="C"&&(e+="(?!%23)")):(e=`&categories_like=${z(t.value)}`,console.log(z(t.value)),console.dir(t)),s.filters+=e))})}function he(e){return/^[a-zA-Z]+$/.test(e)}function z(e){return e.replace(/[!@#$%^&*()\s]/g,function(a){return encodeURIComponent(a)})}function be(e,a){const t=[...a];e.checked=t.every(c=>c.checked)}function Q(){F[0].checked||u++,(f.value||p.value)&&u++,Z.forEach(e=>{e.checked&&u++}),Y.forEach(e=>e.innerHTML=u),u=0}function ee(e){const a=document.querySelectorAll(".js-filterRatingNum"),t=a.length,c={5:0,4:0,3:0,2:0,1:0};e.forEach(r=>{const l=Math.floor(parseFloat(r.rate));if(l>=1)for(let n=1;n<=l;n++)c[n]++});for(let r=0;r<t;r++)a[r].innerHTML=`(${c[t-r]} 筆)`}function ye(e){const a=document.querySelectorAll("[data-category]"),t=a.length,c={};for(let r=0;r<a.length;r++){let l=a[r].dataset.category;c[l]=0}e.forEach(r=>{r.categories.forEach(l=>{c[l]++}),c[r.level]++});for(let r=0;r<t;r++){let l=a[r].dataset.category;a[r].innerHTML=`(${c[l]})`}}ue.addEventListener("click",xe);function xe(){f.value="",p.value="",F[0].checked=!0,document.querySelectorAll(".js-selectAll, .js-category").forEach(a=>a.checked=!1),s.rate_gte=0,s.rate_lte=5,s.price_gte=M,s.price_lte=D,s.filters="",$e(),j()}function $e(){u=0,Y.forEach(e=>e.innerHTML=u)}function P(){window.scrollTo({top:350,left:0,behavior:"smooth"})}const te=document.querySelector(".pagination");te.addEventListener("click",e=>{const a=e.target.closest("[data-page]");if(a){e.preventDefault();const{page:t}=a.dataset;switch(t){case"prev":s.page-=1;break;case"next":s.page+=1;break;default:s.page=Number(t)}i(s),P()}});const A=document.querySelector("#courseList"),ve=ce.replace("course","course_intro");A&&ne(A);function O(){const e=document.querySelectorAll("input");E?e.forEach(a=>{a.disabled=!0}):e.forEach(a=>{a.disabled=!1})}function V(){Se();let e="";E?e+=`
      ...
      </div>`,A.innerHTML=e;let a=document.querySelectorAll(".follow-btn");a.forEach(t=>{t.addEventListener("click",function(){a&&k?t.classList.contains("following")?X(t,!0):X(t,!1):le()})})}function we(){const e=[...Array(T)].map((c,r)=>`<li class="page-item ${s.page===r+1?"active":""}" aria-current="page">
