import{c,a as o,i as p}from"./main-64c8deac.js";import{h as m}from"./startCourse-2b1863b9.js";import"./swal-5831e0de.js";window.addEventListener("load",d);new Swiper(".bannerSwiper",{slidesPerView:1,loop:!0,pagination:{el:".bannerSwiper-pagination",clickable:!0}});let r;const w=document.querySelectorAll(".banner-btn-search"),f=document.querySelectorAll(".banner-input");f.forEach(e=>{e.addEventListener("input",()=>{r=e.value,document.querySelectorAll(".clear-input").forEach(i=>{i.addEventListener("click",function(){e.value="",r=e.value})})})});w.forEach(e=>{e.addEventListener("click",()=>{r&&(localStorage.setItem("indexSearchInput",r),location.href="./course.html")}),document.addEventListener("keyup",function(t){t.key==="Enter"&&e.click()})});const l=/\/[^/]+\.html/,h=l.test(c)?c.replace(l,"/course_intro.html"):c+"course_intro.html";o.get("https://project-code-json.onrender.com/courses?_expand=teacher").then(e=>{let s=e.data.filter(a=>a.badges.includes("熱門")).slice(0,7),n="";const u=document.querySelector(".recommend-swiper");s.forEach(a=>{n+=`<div class="card teacher-card swiper-slide">
