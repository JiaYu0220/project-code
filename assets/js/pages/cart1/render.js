/***** 渲染 *****/
import { myCarts, nextPurchaseCarts } from './cart';
      ...
      <li data-course="${cart.courseId}">
          ...
          cart.course?.duration
                    ...
                    <div class="d-flex justify-content-between mb-3">
                      <div class="d-flex gap-3">
                        <h4 class="fs-5 fs-md-4 fw-bold">
                          NT$ <span class="OriginalCoursePrice">${cart.course?.price.toLocaleString()}</span>
                        </h4>
                      </div>
                    </div>
                  </div>
...
function renderPaymentInfo(target) {
  ...
  // 繳費期限
  info.querySelector('.js-dueDate').innerHTML = `${dueDate} 23:59:59`;
}
